...
const SDK_VERSION = 'v1.55.7-alpha';
...
export const HYPERSTACK_CLIENT = sanitize(SDK_NAME + '/' + SDK_VERSION);
/**
 ...
 */
export const HYPERSTACK_USER_AGENT = isNode
 ...
 */
export const applyHyperstackHeaders = function (args) {
    const headers = {};
