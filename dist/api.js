...
exports.ExportBillingDataRequestResourceTypeEnum = {
    ...
    return {
        ...
        retrieveApiKeys(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['ApiKeyApi.retrieveApiKeys']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
...
class ApiKeyApi extends base_1.BaseAPI {
     ...
     */
    retrieveApiKeys(options) {
        return (0, exports.ApiKeyApiFp)(this.configuration).retrieveApiKeys(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the name and optionally the description of a specified API key. Include the ID of the API key in the path and the new name and optional description in the body of the request.
     * @summary Update API Key
...
const AssigningMemberRoleApiAxiosParamCreator = function (configuration) {
    return {
        ...
        assignRbacRole: (userId_1, payload_1, ...args_1) => __awaiter(this, [userId_1, payload_1, ...args_1], void 0, function* (userId, payload, options = {}) {
            ...
            (0, common_1.assertParamExists)('assignRbacRole', 'userId', userId);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('assignRbacRole', 'payload', payload);
    ...
    return {
        ...
        assignRbacRole(userId, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['AssigningMemberRoleApi.assignRbacRole']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
...
class AssigningMemberRoleApi extends base_1.BaseAPI {
     ...
     */
    assignRbacRole(userId, payload, options) {
        return (0, exports.AssigningMemberRoleApiFp)(this.configuration).assignRbacRole(userId, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Removes an RBAC role from a user within your organization, revoking the resource permissions they had access to. Provide the user ID in the path. For additional information, [click here](https://infrahub-doc.nexgencloud.com/docs/api-reference/auth-resources/rbac/manage-member-roles/revoke-rbac-role).
     * @summary Remove RBAC Role From User
...
const BillingApiAxiosParamCreator = function (configuration) {
    return {
        ...
        retrieveBillingHistoryOfASpecificSnapshotForASpecificBillingCycle: (snapshotId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [snapshotId_1, startDate_1, endDate_1, ...args_1], void 0, function* (snapshotId, startDate, endDate, options = {}) {
            ...
            (0, common_1.assertParamExists)('retrieveBillingHistoryOfASpecificSnapshotForASpecificBillingCycle', 'snapshotId', snapshotId);
        ...
        retrieveBillingHistoryOfASpecificVirtualMachineForASpecificBillingCycle: (vmId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [vmId_1, startDate_1, endDate_1, ...args_1], void 0, function* (vmId, startDate, endDate, options = {}) {
            ...
            (0, common_1.assertParamExists)('retrieveBillingHistoryOfASpecificVirtualMachineForASpecificBillingCycle', 'vmId', vmId);
        ...
        retrieveBillingHistoryOfASpecificVolumeForASpecificBillingCycle: (volumeId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [volumeId_1, startDate_1, endDate_1, ...args_1], void 0, function* (volumeId, startDate, endDate, options = {}) {
            ...
            (0, common_1.assertParamExists)('retrieveBillingHistoryOfASpecificVolumeForASpecificBillingCycle', 'volumeId', volumeId);
        ...
        retrieveHourlyCostDatapointsOfASpecificSnapshotForASpecificBillingCycle: (snapshotId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [snapshotId_1, startDate_1, endDate_1, ...args_1], void 0, function* (snapshotId, startDate, endDate, options = {}) {
            // verify required parameter 'snapshotId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveHourlyCostDatapointsOfASpecificSnapshotForASpecificBillingCycle', 'snapshotId', snapshotId);
        ...
        retrieveHourlyCostDatapointsOfASpecificVirtualMachineForASpecificBillingCycle: (vmId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [vmId_1, startDate_1, endDate_1, ...args_1], void 0, function* (vmId, startDate, endDate, options = {}) {
            // verify required parameter 'vmId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveHourlyCostDatapointsOfASpecificVirtualMachineForASpecificBillingCycle', 'vmId', vmId);
        ...
        retrieveHourlyCostDatapointsOfASpecificVolumeForASpecificBillingCycle: (volumeId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [volumeId_1, startDate_1, endDate_1, ...args_1], void 0, function* (volumeId, startDate, endDate, options = {}) {
            // verify required parameter 'volumeId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveHourlyCostDatapointsOfASpecificVolumeForASpecificBillingCycle', 'volumeId', volumeId);
        ...
        retrieveSubResourcesHistoricalCostDatapointsOfAVirtual: (vmId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [vmId_1, startDate_1, endDate_1, ...args_1], void 0, function* (vmId, startDate, endDate, options = {}) {
            // verify required parameter 'vmId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveSubResourcesHistoricalCostDatapointsOfAVirtual', 'vmId', vmId);
        ...
        retrieveTotalCostsAndNonDiscountCostsForSubResources: (vmId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [vmId_1, startDate_1, endDate_1, ...args_1], void 0, function* (vmId, startDate, endDate, options = {}) {
            // verify required parameter 'vmId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveTotalCostsAndNonDiscountCostsForSubResources', 'vmId', vmId);
        ...
        retrieveVmBillingEventsHistory: (vmId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [vmId_1, startDate_1, endDate_1, ...args_1], void 0, function* (vmId, startDate, endDate, options = {}) {
            // verify required parameter 'vmId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveVmBillingEventsHistory', 'vmId', vmId);
        ...
        retrieveVolumeBillingEventsHistory: (volumeId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [volumeId_1, startDate_1, endDate_1, ...args_1], void 0, function* (volumeId, startDate, endDate, options = {}) {
            // verify required parameter 'volumeId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveVolumeBillingEventsHistory', 'volumeId', volumeId);
        ...
        updateSubscribeOrUnsubscribeNotificationThreshold: (thresholdId_1, payload_1, ...args_1) => __awaiter(this, [thresholdId_1, payload_1, ...args_1], void 0, function* (thresholdId, payload, options = {}) {
            ...
            (0, common_1.assertParamExists)('updateSubscribeOrUnsubscribeNotificationThreshold', 'thresholdId', thresholdId);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('updateSubscribeOrUnsubscribeNotificationThreshold', 'payload', payload);
    ...
    return {
        ...
        getAllThresholdsForOrganization(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.getAllThresholdsForOrganization']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        getBillingUsage(deleted, environment, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.getBillingUsage']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveBillingHistoryForASpecificBillingCycle(startDate, endDate, graph, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveBillingHistoryForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveBillingHistoryOfASpecificSnapshotForASpecificBillingCycle(snapshotId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveBillingHistoryOfASpecificSnapshotForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveBillingHistoryOfASpecificVirtualMachineForASpecificBillingCycle(vmId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveBillingHistoryOfASpecificVirtualMachineForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveBillingHistoryOfASpecificVolumeForASpecificBillingCycle(volumeId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveBillingHistoryOfASpecificVolumeForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveBillingHistoryOfContractForASpecificBillingCycle(startDate, endDate, search, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveBillingHistoryOfContractForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveBillingHistoryOfSnapshotForASpecificBillingCycle(startDate, endDate, search, page, perPage, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveBillingHistoryOfSnapshotForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveBillingHistoryOfVirtualMachineForASpecificBillingCycle(startDate, endDate, search, perPage, page, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveBillingHistoryOfVirtualMachineForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveBillingHistoryOfVolumeForASpecificBillingCycle(startDate, endDate, search, perPage, page, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveBillingHistoryOfVolumeForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveHourlyCostDatapointsOfASpecificSnapshotForASpecificBillingCycle(snapshotId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveHourlyCostDatapointsOfASpecificSnapshotForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveHourlyCostDatapointsOfASpecificVirtualMachineForASpecificBillingCycle(vmId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveHourlyCostDatapointsOfASpecificVirtualMachineForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveHourlyCostDatapointsOfASpecificVolumeForASpecificBillingCycle(volumeId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveHourlyCostDatapointsOfASpecificVolumeForASpecificBillingCycle']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveSubResourcesHistoricalCostDatapointsOfAVirtual(vmId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveSubResourcesHistoricalCostDatapointsOfAVirtual']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveTotalCostsAndNonDiscountCostsForSubResources(vmId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveTotalCostsAndNonDiscountCostsForSubResources']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveVmBillingEventsHistory(vmId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveVmBillingEventsHistory']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveVolumeBillingEventsHistory(volumeId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.retrieveVolumeBillingEventsHistory']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        updateSubscribeOrUnsubscribeNotificationThreshold(thresholdId, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BillingApi.updateSubscribeOrUnsubscribeNotificationThreshold']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class BillingApi extends base_1.BaseAPI {
     ...
     */
    getAllThresholdsForOrganization(options) {
        return (0, exports.BillingApiFp)(this.configuration).getAllThresholdsForOrganization(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve active billing metrics for the organization\'s resources, including pricing, uptime, and total cost. Returns usage details for each active resource by defualt(`deleted=false` will return active resources). Additionally, adding `deleted=true` in query parameter will return inactive resources. For additional information on view usage costs for all resources, [**click here**](https://infrahub-doc.nexgencloud.com/docs/billing-and-payment/billing-features#view-usage-costs-for-all-resources)
     * @summary GET: Billing usage
     ...
     */
    getBillingUsage(deleted, environment, options) {
        return (0, exports.BillingApiFp)(this.configuration).getBillingUsage(deleted, environment, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve the previous day\'s costs for instances, volumes, and clusters. Returns a breakdown of the costs and the total cost for the last day. For additional information on Retrieve Previous Day Usage Costs, [**click here**](https://infrahub-doc.nexgencloud.com/docs/api-reference/billing-resources/last-day-usage/)
     * @summary GET: Last Day Cost
     ...
     */
    retrieveBillingHistoryForASpecificBillingCycle(startDate, endDate, graph, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveBillingHistoryForASpecificBillingCycle(startDate, endDate, graph, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve billing history of a specific Snapshot for the specified billing cycle. This data will include \'resource_name\', \'infrahub_id\', \'price_per_hour\', \'incurred_bill\', \'usage_time\', \'non_discounted_price_per_hour\', \'non_discounted_bill\'.
     * @summary Retrieve Billing History of a Specific Snapshot for a specific Billing Cycle
     ...
     */
    retrieveBillingHistoryOfASpecificSnapshotForASpecificBillingCycle(snapshotId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveBillingHistoryOfASpecificSnapshotForASpecificBillingCycle(snapshotId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will recieve billing history of a specific Virtual Machine for the specified billing cycle. This data will include \'resource_name\', \'infrahub_id\', \'price_per_hour\', \'non_discounted_price_per_hour\', \'incurred_bill\', \'non_discounted_bill\', \'usage_time\', \'usage_time_ACTIVE\', \'usage_time_SHUTOFF\', \'usage_time_HIBERNATED\'
     * @summary Retrieve Billing History of a Specific Virtual Machine for a specific Billing Cycle
     ...
     */
    retrieveBillingHistoryOfASpecificVirtualMachineForASpecificBillingCycle(vmId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveBillingHistoryOfASpecificVirtualMachineForASpecificBillingCycle(vmId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve billing history of a specific Volume for the specified billing cycle. This data will include \'resource_name\', \'infrahub_id\', \'price_per_hour\', \'incurred_bill\', \'usage_time\', \'non_discounted_price_per_hour\', \'non_discounted_bill\'.
     * @summary Retrieve Billing History of a Specific Volume for a specific Billing Cycle
     ...
     */
    retrieveBillingHistoryOfASpecificVolumeForASpecificBillingCycle(volumeId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveBillingHistoryOfASpecificVolumeForASpecificBillingCycle(volumeId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will recieve billing history of contracts for the specified billing cycle. This data will include \'description\', gpu_type\',\'infrahub_id\', \'status\', \'incurred_bill\', \'price_per_hour\'
     * @summary Retrieve Billing History of Contract for a specific Billing Cycle
     ...
     */
    retrieveBillingHistoryOfContractForASpecificBillingCycle(startDate, endDate, search, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveBillingHistoryOfContractForASpecificBillingCycle(startDate, endDate, search, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will recieve billing history of snapshots for thespecified billing cycle. This data will include \'resource_name\', \'infrahub_id\', \'status\', \'incurred_bill\', \'usage_time\', \'price_per_hour\'
     * @summary Retrieve Billing History of Snapshot for a specific Billing Cycle
     ...
     */
    retrieveBillingHistoryOfSnapshotForASpecificBillingCycle(startDate, endDate, search, page, perPage, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveBillingHistoryOfSnapshotForASpecificBillingCycle(startDate, endDate, search, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will recieve billing history of virtual machine for the specified billing cycle. This data will include \'resource_name\', \'infrahub_id\', \'status\', \'incurred_bill\', \'usage_time\', \'price_per_hour\'
     * @summary Retrieve Billing History of Virtual Machine for a specific Billing Cycle
     ...
     */
    retrieveBillingHistoryOfVirtualMachineForASpecificBillingCycle(startDate, endDate, search, perPage, page, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveBillingHistoryOfVirtualMachineForASpecificBillingCycle(startDate, endDate, search, perPage, page, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will recieve billing history of volumes for thespecified billing cycle. This data will include \'resource_name\', \'infrahub_id\', \'status\', \'incurred_bill\', \'usage_time\', \'price_per_hour\'
     * @summary Retrieve Billing History of Volume for a specific Billing Cycle
     ...
     */
    retrieveBillingHistoryOfVolumeForASpecificBillingCycle(startDate, endDate, search, perPage, page, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveBillingHistoryOfVolumeForASpecificBillingCycle(startDate, endDate, search, perPage, page, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will recieve hourly cost datapoints for a Snapshot for a specified billing cycle. This data will include \'incurred_bill\' graph datapoints.
     * @summary Retrieve hourly cost datapoints of a Specific Snapshot for a specific billing cycle
     ...
     */
    retrieveHourlyCostDatapointsOfASpecificSnapshotForASpecificBillingCycle(snapshotId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveHourlyCostDatapointsOfASpecificSnapshotForASpecificBillingCycle(snapshotId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will recieve hourly cost datapoints for a VM for a specified billing cycle. This data will include \'incurred_bill\' graph datapoints.
     * @summary Retrieve hourly cost datapoints of a Specific Virtual Machine for a specific billing cycle
     ...
     */
    retrieveHourlyCostDatapointsOfASpecificVirtualMachineForASpecificBillingCycle(vmId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveHourlyCostDatapointsOfASpecificVirtualMachineForASpecificBillingCycle(vmId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will recieve hourly cost datapoints for a Volume for a specified billing cycle. This data will include \'incurred_bill\' graph datapoints.
     * @summary Retrieve hourly cost datapoints of a Specific Volume for a specific billing cycle
     ...
     */
    retrieveHourlyCostDatapointsOfASpecificVolumeForASpecificBillingCycle(volumeId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveHourlyCostDatapointsOfASpecificVolumeForASpecificBillingCycle(volumeId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will recieve sub-resources historical cost datapoints for a VM sub resources for a specified billing cycle. This data will include \'incurred_bill\' graph datapoints. Machine sub resources for a specific billing cycle
     * @summary Retrieve Sub-Resources Historical Cost datapoints of a Virtual
     ...
     */
    retrieveSubResourcesHistoricalCostDatapointsOfAVirtual(vmId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveSubResourcesHistoricalCostDatapointsOfAVirtual(vmId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will get total costs and non_discount costs of sub resources on a specific Virtual Machine for the specified billing cycle. on a Specific VM for the Specified Billing Cycle
     * @summary Retrieve Total Costs and Non Discount Costs for Sub Resources
     ...
     */
    retrieveTotalCostsAndNonDiscountCostsForSubResources(vmId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveTotalCostsAndNonDiscountCostsForSubResources(vmId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will receive vm billing events history
     * @summary Retrieve VM billing events history
     ...
     */
    retrieveVmBillingEventsHistory(vmId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveVmBillingEventsHistory(vmId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * User will receive volume billing events history
     * @summary Retrieve Volume billing events history
     ...
     */
    retrieveVolumeBillingEventsHistory(volumeId, startDate, endDate, options) {
        return (0, exports.BillingApiFp)(this.configuration).retrieveVolumeBillingEventsHistory(volumeId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * By default, you are subscribed to all the threshold values and you will be receiving the email notification for these default thresholds values. `false` indicates that the user will no longer receive notifications for this specific threshold, whereas `true` signifies that the user will receive notification emails.
     * @summary Update: Subscribe or Unsubscribe Notification Threshold
     ...
     */
    updateSubscribeOrUnsubscribeNotificationThreshold(thresholdId, payload, options) {
        return (0, exports.BillingApiFp)(this.configuration).updateSubscribeOrUnsubscribeNotificationThreshold(thresholdId, payload, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const CalculateApiAxiosParamCreator = function (configuration) {
    return {
        ...
        retrieveBillingRateForResource: (resourceType_1, id_1, ...args_1) => __awaiter(this, [resourceType_1, id_1, ...args_1], void 0, function* (resourceType, id, options = {}) {
            ...
            (0, common_1.assertParamExists)('retrieveBillingRateForResource', 'resourceType', resourceType);
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('retrieveBillingRateForResource', 'id', id);
    ...
    return {
        ...
        retrieveBillingRateForResource(resourceType, id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['CalculateApi.retrieveBillingRateForResource']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class CalculateApi extends base_1.BaseAPI {
     ...
     */
    retrieveBillingRateForResource(resourceType, id, options) {
        return (0, exports.CalculateApiFp)(this.configuration).retrieveBillingRateForResource(resourceType, id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const CallbacksApiAxiosParamCreator = function (configuration) {
    return {
        ...
        attachCallbackToVirtualMachine: (id_1, payload_1, ...args_1) => __awaiter(this, [id_1, payload_1, ...args_1], void 0, function* (id, payload, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('attachCallbackToVirtualMachine', 'id', id);
            // verify required parameter 'payload' is not null or undefined
        ...
        attachCallbackToVolume: (id_1, payload_1, ...args_1) => __awaiter(this, [id_1, payload_1, ...args_1], void 0, function* (id, payload, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('attachCallbackToVolume', 'id', id);
            // verify required parameter 'payload' is not null or undefined
        ...
        deleteVirtualMachineCallback: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('deleteVirtualMachineCallback', 'id', id);
        ...
        deleteVolumeCallback: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('deleteVolumeCallback', 'id', id);
        ...
        updateVirtualMachineCallback: (id_1, payload_1, ...args_1) => __awaiter(this, [id_1, payload_1, ...args_1], void 0, function* (id, payload, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('updateVirtualMachineCallback', 'id', id);
            // verify required parameter 'payload' is not null or undefined
        ...
        updateVolumeCallback: (id_1, payload_1, ...args_1) => __awaiter(this, [id_1, payload_1, ...args_1], void 0, function* (id, payload, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('updateVolumeCallback', 'id', id);
            // verify required parameter 'payload' is not null or undefined
...
class CallbacksApi extends base_1.BaseAPI {
     ...
     */
    attachCallbackToVirtualMachine(id, payload, options) {
        return (0, exports.CallbacksApiFp)(this.configuration).attachCallbackToVirtualMachine(id, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Creates a callback URL for a specified volume, enabling the posting of action events executed on the volume to the specified URL. Provide the callback URL in the request body and the ID of the volume to which it is being attached in the path. For more details on volume callback URLs, [**click here**](https://infrahub-doc.nexgencloud.com/docs/features/webhooks-callbacks).
     * @summary Attach callback to volume
     ...
     */
    attachCallbackToVolume(id, payload, options) {
        return (0, exports.CallbacksApiFp)(this.configuration).attachCallbackToVolume(id, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Permanently deletes the callback URL associated with a specified virtual machine by providing the virtual machine ID in the request path. For additional information on virtual machine callback URLs, [**click here**](https://infrahub-doc.nexgencloud.com/docs/features/webhooks-callbacks).
     * @summary Delete virtual machine callback
     ...
     */
    deleteVirtualMachineCallback(id, options) {
        return (0, exports.CallbacksApiFp)(this.configuration).deleteVirtualMachineCallback(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Permanently deletes the callback URL associated with a specified volume by providing the volume ID in the request path. For additional information on volume callback URLs, [**click here**](https://infrahub-doc.nexgencloud.com/docs/features/webhooks-callbacks).
     * @summary Delete volume callback
     ...
     */
    deleteVolumeCallback(id, options) {
        return (0, exports.CallbacksApiFp)(this.configuration).deleteVolumeCallback(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the callback URL for a specified virtual machine. Provide the new callback URL in the request body, along with the ID of the associated virtual machine in the path. For additional information on virtual machine callback URLs, [**click here**](https://infrahub-doc.nexgencloud.com/docs/features/webhooks-callbacks).
     * @summary Update virtual machine callback
     ...
     */
    updateVirtualMachineCallback(id, payload, options) {
        return (0, exports.CallbacksApiFp)(this.configuration).updateVirtualMachineCallback(id, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the callback URL for a specified volume. Provide the new callback URL in the request body, along with the ID of the associated volume in the path. For additional information on volume callback URLs, [**click here**](https://infrahub-doc.nexgencloud.com/docs/features/webhooks-callbacks).
     * @summary Update volume callback
     ...
     */
    updateVolumeCallback(id, payload, options) {
        return (0, exports.CallbacksApiFp)(this.configuration).updateVolumeCallback(id, payload, options).then((request) => request(this.axios, this.basePath));
    }
}
...
class ClustersApi extends base_1.BaseAPI {
     ...
     */
    getClusterVersions(options) {
        return (0, exports.ClustersApiFp)(this.configuration).getClusterVersions(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Getting Cluster Detail
     ...
     */
    listClusters(options) {
        return (0, exports.ClustersApiFp)(this.configuration).listClusters(options).then((request) => request(this.axios, this.basePath));
    }
}
    ...
    return {
        ...
        retrieveGpuCompliance(gpu, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['ComplianceApi.retrieveGpuCompliance']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
...
class ComplianceApi extends base_1.BaseAPI {
     ...
     */
    retrieveGpuCompliance(gpu, options) {
        return (0, exports.ComplianceApiFp)(this.configuration).retrieveGpuCompliance(gpu, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Update a compliance
    ...
    return {
        ...
        getViewCreditAndThreshold(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['CreditApi.getViewCreditAndThreshold']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class CreditApi extends base_1.BaseAPI {
     ...
     */
    getViewCreditAndThreshold(options) {
        return (0, exports.CreditApiFp)(this.configuration).getViewCreditAndThreshold(options).then((request) => request(this.axios, this.basePath));
    }
}
...
const CustomerContractApiAxiosParamCreator = function (configuration) {
    return {
        ...
        retrieveContractDetails: (contractId_1, ...args_1) => __awaiter(this, [contractId_1, ...args_1], void 0, function* (contractId, options = {}) {
            ...
            (0, common_1.assertParamExists)('retrieveContractDetails', 'contractId', contractId);
        ...
        retrieveGpuAllocationGraphForContract: (contractId_1, startDate_1, endDate_1, ...args_1) => __awaiter(this, [contractId_1, startDate_1, endDate_1, ...args_1], void 0, function* (contractId, startDate, endDate, options = {}) {
            // verify required parameter 'contractId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveGpuAllocationGraphForContract', 'contractId', contractId);
    ...
    return {
        ...
        listContracts(page, perPage, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['CustomerContractApi.listContracts']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveContractDetails(contractId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['CustomerContractApi.retrieveContractDetails']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveGpuAllocationGraphForContract(contractId, startDate, endDate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['CustomerContractApi.retrieveGpuAllocationGraphForContract']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class CustomerContractApi extends base_1.BaseAPI {
     ...
     */
    listContracts(page, perPage, options) {
        return (0, exports.CustomerContractApiFp)(this.configuration).listContracts(page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve details of a specific contract by providing the contract ID in the path. The endpoint returns the contract object along with its associated discount plans. For more information, [**click here**](https://infrahub-doc.nexgencloud.com/docs/api-reference/pricebook-resources/retrieve-contract-details).
     * @summary Retrieve Contract Details
     ...
     */
    retrieveContractDetails(contractId, options) {
        return (0, exports.CustomerContractApiFp)(this.configuration).retrieveContractDetails(contractId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve GPU allocation count graph for a specific contract by providing the contract ID in the path. The endpoint returns the GPU allocation count graph for the contract within the specified date range.
     * @summary Retrieve GPU Allocation Graph for Contract
     ...
     */
    retrieveGpuAllocationGraphForContract(contractId, startDate, endDate, options) {
        return (0, exports.CustomerContractApiFp)(this.configuration).retrieveGpuAllocationGraphForContract(contractId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const FirewallAttachmentApiAxiosParamCreator = function (configuration) {
    return {
        ...
        attachFirewallsToVms: (firewallId_1, payload_1, ...args_1) => __awaiter(this, [firewallId_1, payload_1, ...args_1], void 0, function* (firewallId, payload, options = {}) {
            ...
            (0, common_1.assertParamExists)('attachFirewallsToVms', 'firewallId', firewallId);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('attachFirewallsToVms', 'payload', payload);
    ...
    return {
        ...
        attachFirewallsToVms(firewallId, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FirewallAttachmentApi.attachFirewallsToVms']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class FirewallAttachmentApi extends base_1.BaseAPI {
     ...
     */
    attachFirewallsToVms(firewallId, payload, options) {
        return (0, exports.FirewallAttachmentApiFp)(this.configuration).attachFirewallsToVms(firewallId, payload, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const FirewallsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        addFirewallRuleToFirewall: (firewallId_1, payload_1, ...args_1) => __awaiter(this, [firewallId_1, payload_1, ...args_1], void 0, function* (firewallId, payload, options = {}) {
            // verify required parameter 'firewallId' is not null or undefined
            (0, common_1.assertParamExists)('addFirewallRuleToFirewall', 'firewallId', firewallId);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('addFirewallRuleToFirewall', 'payload', payload);
        ...
        createFirewall: (payload_1, ...args_1) => __awaiter(this, [payload_1, ...args_1], void 0, function* (payload, options = {}) {
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('createFirewall', 'payload', payload);
        ...
        deleteFirewall: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('deleteFirewall', 'id', id);
        ...
        deleteFirewallRulesFromFirewall: (firewallId_1, firewallRuleId_1, ...args_1) => __awaiter(this, [firewallId_1, firewallRuleId_1, ...args_1], void 0, function* (firewallId, firewallRuleId, options = {}) {
            // verify required parameter 'firewallId' is not null or undefined
            (0, common_1.assertParamExists)('deleteFirewallRulesFromFirewall', 'firewallId', firewallId);
            // verify required parameter 'firewallRuleId' is not null or undefined
            (0, common_1.assertParamExists)('deleteFirewallRulesFromFirewall', 'firewallRuleId', firewallRuleId);
        ...
        retrieveFirewallDetails: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('retrieveFirewallDetails', 'id', id);
            const localVarPath = `/core/firewalls/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
    ...
    return {
        ...
        addFirewallRuleToFirewall(firewallId, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FirewallsApi.addFirewallRuleToFirewall']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        createFirewall(payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FirewallsApi.createFirewall']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        deleteFirewall(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FirewallsApi.deleteFirewall']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        deleteFirewallRulesFromFirewall(firewallId, firewallRuleId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FirewallsApi.deleteFirewallRulesFromFirewall']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        listFirewalls(page, pageSize, search, environment, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FirewallsApi.listFirewalls']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveFirewallDetails(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FirewallsApi.retrieveFirewallDetails']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class FirewallsApi extends base_1.BaseAPI {
     ...
     */
    addFirewallRuleToFirewall(firewallId, payload, options) {
        return (0, exports.FirewallsApiFp)(this.configuration).addFirewallRuleToFirewall(firewallId, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Creates a firewall to which firewall rules can be added. A firewall can be attached to one or more virtual machines to control inbound and outbound traffic. In the body of the request, include the name of the firewall, the ID of the environment within which the firewall will be created, and an optional description. To obtain the ID of the environment, make a request to the [**list environments**](https://infrahub-doc.nexgencloud.com/docs/api-reference/core-resources/environments/list-environments) endpoint.
     * @summary Create firewall
     ...
     */
    createFirewall(payload, options) {
        return (0, exports.FirewallsApiFp)(this.configuration).createFirewall(payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Deletes a firewall by specifying the firewall ID in the path. If the firewall is currently attached to a virtual machine, it must be detached before deletion. For more information, [**click here**](https://infrahub-doc.nexgencloud.com/docs/api-reference/core-resources/firewalls/delete-firewall).
     * @summary Delete firewall
     ...
     */
    deleteFirewall(id, options) {
        return (0, exports.FirewallsApiFp)(this.configuration).deleteFirewall(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Removes a firewall rule from firewall by providing the firewall ID and firewall rule ID in the path. For more information, [**click here**](https://infrahub-doc.nexgencloud.com/docs/api-reference/core-resources/firewalls/remove-firewall-rule-from-firewall).
     * @summary Delete firewall rules from firewall
     ...
     */
    deleteFirewallRulesFromFirewall(firewallId, firewallRuleId, options) {
        return (0, exports.FirewallsApiFp)(this.configuration).deleteFirewallRulesFromFirewall(firewallId, firewallRuleId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a list of existing firewalls and their details, including the security rules they contain and information about the virtual machines to which they are attached. For more information about the firewalls features offered by Infrahub, [**click here**](https://infrahub-doc.nexgencloud.com/docs/network-security/security-groups).
     * @summary List firewalls
     ...
     */
    listFirewalls(page, pageSize, search, environment, options) {
        return (0, exports.FirewallsApiFp)(this.configuration).listFirewalls(page, pageSize, search, environment, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves the details of an existing firewall, including the security rules it contains and information about the virtual machines to which it is attached.
     * @summary Retrieve firewall details
     ...
     */
    retrieveFirewallDetails(id, options) {
        return (0, exports.FirewallsApiFp)(this.configuration).retrieveFirewallDetails(id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const FloatingIpApiAxiosParamCreator = function (configuration) {
    return {
        ...
        attachPublicIpToVirtualMachine: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('attachPublicIpToVirtualMachine', 'id', id);
        ...
        detachPublicIpFromVirtualMachine: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('detachPublicIpFromVirtualMachine', 'id', id);
...
class FloatingIpApi extends base_1.BaseAPI {
     ...
     */
    attachPublicIpToVirtualMachine(id, options) {
        return (0, exports.FloatingIpApiFp)(this.configuration).attachPublicIpToVirtualMachine(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Removes a public IP address from an existing virtual machine, disabling internet accessibility to the VM. Include the virtual machine ID in the path to detach the public IP from the specified VM. For more information on public IP addresses, [**click here**](https://infrahub-doc.nexgencloud.com/docs/virtual-machines/public-ip).
     * @summary Detach public IP from virtual machine
     ...
     */
    detachPublicIpFromVirtualMachine(id, options) {
        return (0, exports.FloatingIpApiFp)(this.configuration).detachPublicIpFromVirtualMachine(id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const ImageApiAxiosParamCreator = function (configuration) {
    return {
        ...
        deleteAnImage: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('deleteAnImage', 'id', id);
        ...
        fetchNameAvailabilityForImages: (name_1, ...args_1) => __awaiter(this, [name_1, ...args_1], void 0, function* (name, options = {}) {
            // verify required parameter 'name' is not null or undefined
            (0, common_1.assertParamExists)('fetchNameAvailabilityForImages', 'name', name);
        ...
        getPrivateImageDetails: (id_1, includeRelatedVms_1, ...args_1) => __awaiter(this, [id_1, includeRelatedVms_1, ...args_1], void 0, function* (id, includeRelatedVms, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getPrivateImageDetails', 'id', id);
            const localVarPath = `/core/images/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
    ...
    return {
        ...
        deleteAnImage(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['ImageApi.deleteAnImage']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        fetchNameAvailabilityForImages(name, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['ImageApi.fetchNameAvailabilityForImages']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        getPrivateImageDetails(id, includeRelatedVms, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['ImageApi.getPrivateImageDetails']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        listImages(region, includePublic, search, page, perPage, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['ImageApi.listImages']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class ImageApi extends base_1.BaseAPI {
     ...
     */
    deleteAnImage(id, options) {
        return (0, exports.ImageApiFp)(this.configuration).deleteAnImage(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Check if an Image name is available
     * @summary Fetch name availability for Images
     ...
     */
    fetchNameAvailabilityForImages(name, options) {
        return (0, exports.ImageApiFp)(this.configuration).fetchNameAvailabilityForImages(name, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve details of a specific image by providing the image ID.
     * @summary Get Private Image Details
     ...
     */
    getPrivateImageDetails(id, includeRelatedVms, options) {
        return (0, exports.ImageApiFp)(this.configuration).getPrivateImageDetails(id, includeRelatedVms, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of all available operating system (OS) images, providing details about each image\'s corresponding virtual machine operating system. You can include the optional `region` parameter in the query string of the request to specifically return OS images from the designated region. Additionally, use the `include_public` parameter to specify whether to include public images in the response. For more information onOS images, [**click here**](https://infrahub-doc.nexgencloud.com/docs/virtual-machines/images).
     * @summary List Images
     ...
     */
    listImages(region, includePublic, search, page, perPage, options) {
        return (0, exports.ImageApiFp)(this.configuration).listImages(region, includePublic, search, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const PaymentApiAxiosParamCreator = function (configuration) {
    return {
        ...
        postInitiatePayment: (payload_1, ...args_1) => __awaiter(this, [payload_1, ...args_1], void 0, function* (payload, options = {}) {
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('postInitiatePayment', 'payload', payload);
    ...
    return {
        ...
        getViewPaymentDetails(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['PaymentApi.getViewPaymentDetails']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        postInitiatePayment(payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['PaymentApi.postInitiatePayment']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class PaymentApi extends base_1.BaseAPI {
     ...
     */
    getViewPaymentDetails(options) {
        return (0, exports.PaymentApiFp)(this.configuration).getViewPaymentDetails(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary POST: Initiate payment
     ...
     */
    postInitiatePayment(payload, options) {
        return (0, exports.PaymentApiFp)(this.configuration).postInitiatePayment(payload, options).then((request) => request(this.axios, this.basePath));
    }
}
    ...
    return {
        ...
        retrivePricebook(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['PricebookApi.retrivePricebook']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class PricebookApi extends base_1.BaseAPI {
     ...
     */
    retrivePricebook(options) {
        return (0, exports.PricebookApiFp)(this.configuration).retrivePricebook(options).then((request) => request(this.axios, this.basePath));
    }
}
...
const SnapshotsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        createAnImageFromASnapshot: (snapshotId_1, payload_1, ...args_1) => __awaiter(this, [snapshotId_1, payload_1, ...args_1], void 0, function* (snapshotId, payload, options = {}) {
            // verify required parameter 'snapshotId' is not null or undefined
            (0, common_1.assertParamExists)('createAnImageFromASnapshot', 'snapshotId', snapshotId);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('createAnImageFromASnapshot', 'payload', payload);
        ...
        restoreASnapshot: (id_1, payload_1, ...args_1) => __awaiter(this, [id_1, payload_1, ...args_1], void 0, function* (id, payload, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('restoreASnapshot', 'id', id);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('restoreASnapshot', 'payload', payload);
        ...
        retrieveASnapshot: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('retrieveASnapshot', 'id', id);
            const localVarPath = `/core/snapshots/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
    ...
    return {
        ...
        createAnImageFromASnapshot(snapshotId, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['SnapshotsApi.createAnImageFromASnapshot']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        restoreASnapshot(id, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['SnapshotsApi.restoreASnapshot']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveASnapshot(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['SnapshotsApi.retrieveASnapshot']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveListOfSnapshotsWithPagination(page, pageSize, search, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['SnapshotsApi.retrieveListOfSnapshotsWithPagination']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class SnapshotsApi extends base_1.BaseAPI {
     ...
     */
    createAnImageFromASnapshot(snapshotId, payload, options) {
        return (0, exports.SnapshotsApiFp)(this.configuration).createAnImageFromASnapshot(snapshotId, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Delete a snapshot. Provide the snapshot ID in the path to delete the specified snapshot. If the snapshot is connected with an image, that image will also bedeleted and the deleted image ID will be returned in the success message response.
     * @summary Delete snapshot
     ...
     */
    restoreASnapshot(id, payload, options) {
        return (0, exports.SnapshotsApiFp)(this.configuration).restoreASnapshot(id, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve a snapshot.
     * @summary Retrieve a snapshot
     ...
     */
    retrieveASnapshot(id, options) {
        return (0, exports.SnapshotsApiFp)(this.configuration).retrieveASnapshot(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a list of snapshot, providing details such as snapshot name, timestamp, VM ID, and other relevant information.
     * @summary Retrieve list of snapshots with pagination
     ...
     */
    retrieveListOfSnapshotsWithPagination(page, pageSize, search, options) {
        return (0, exports.SnapshotsApiFp)(this.configuration).retrieveListOfSnapshotsWithPagination(page, pageSize, search, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const UserApiAxiosParamCreator = function (configuration) {
    return {
        ...
        postInsertUserInfo: (payload_1, ...args_1) => __awaiter(this, [payload_1, ...args_1], void 0, function* (payload, options = {}) {
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('postInsertUserInfo', 'payload', payload);
            const localVarPath = `/billing/user/info`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
        ...
        putUpdateUserInfo: (payload_1, ...args_1) => __awaiter(this, [payload_1, ...args_1], void 0, function* (payload, options = {}) {
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('putUpdateUserInfo', 'payload', payload);
            const localVarPath = `/billing/user/info`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
    ...
    return {
        ...
        getFetchUserInfo(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['UserApi.getFetchUserInfo']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        postInsertUserInfo(payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['UserApi.postInsertUserInfo']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        putUpdateUserInfo(payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['UserApi.putUpdateUserInfo']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class UserApi extends base_1.BaseAPI {
     ...
     */
    getFetchUserInfo(options) {
        return (0, exports.UserApiFp)(this.configuration).getFetchUserInfo(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary POST: Insert user info
     ...
     */
    postInsertUserInfo(payload, options) {
        return (0, exports.UserApiFp)(this.configuration).postInsertUserInfo(payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary PUT: Update user info
     ...
     */
    putUpdateUserInfo(payload, options) {
        return (0, exports.UserApiFp)(this.configuration).putUpdateUserInfo(payload, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const VirtualMachineApiAxiosParamCreator = function (configuration) {
    return {
        ...
        addFirewallRuleToVirtualMachine: (id_1, payload_1, ...args_1) => __awaiter(this, [id_1, payload_1, ...args_1], void 0, function* (id, payload, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('addFirewallRuleToVirtualMachine', 'id', id);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('addFirewallRuleToVirtualMachine', 'payload', payload);
        ...
        attachFirewallsToAVirtualMachine: (vmId_1, payload_1, ...args_1) => __awaiter(this, [vmId_1, payload_1, ...args_1], void 0, function* (vmId, payload, options = {}) {
            // verify required parameter 'vmId' is not null or undefined
            (0, common_1.assertParamExists)('attachFirewallsToAVirtualMachine', 'vmId', vmId);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('attachFirewallsToAVirtualMachine', 'payload', payload);
        ...
        createSnapshotFromAVirtualMachine: (vmId_1, payload_1, ...args_1) => __awaiter(this, [vmId_1, payload_1, ...args_1], void 0, function* (vmId, payload, options = {}) {
            // verify required parameter 'vmId' is not null or undefined
            (0, common_1.assertParamExists)('createSnapshotFromAVirtualMachine', 'vmId', vmId);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('createSnapshotFromAVirtualMachine', 'payload', payload);
        ...
        createVirtualMachines: (payload_1, ...args_1) => __awaiter(this, [payload_1, ...args_1], void 0, function* (payload, options = {}) {
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('createVirtualMachines', 'payload', payload);
        ...
        deleteFirewallRuleFromVirtualMachine: (virtualMachineId_1, sgRuleId_1, ...args_1) => __awaiter(this, [virtualMachineId_1, sgRuleId_1, ...args_1], void 0, function* (virtualMachineId, sgRuleId, options = {}) {
            ...
            (0, common_1.assertParamExists)('deleteFirewallRuleFromVirtualMachine', 'virtualMachineId', virtualMachineId);
            // verify required parameter 'sgRuleId' is not null or undefined
            (0, common_1.assertParamExists)('deleteFirewallRuleFromVirtualMachine', 'sgRuleId', sgRuleId);
        ...
        deleteVirtualMachine: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('deleteVirtualMachine', 'id', id);
        ...
        editVirtualMachineLabels: (virtualMachineId_1, payload_1, ...args_1) => __awaiter(this, [virtualMachineId_1, payload_1, ...args_1], void 0, function* (virtualMachineId, payload, options = {}) {
            // verify required parameter 'virtualMachineId' is not null or undefined
            (0, common_1.assertParamExists)('editVirtualMachineLabels', 'virtualMachineId', virtualMachineId);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('editVirtualMachineLabels', 'payload', payload);
        ...
        hardRebootVirtualMachine: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('hardRebootVirtualMachine', 'id', id);
        ...
        hibernateVirtualMachine: (virtualMachineId_1, ...args_1) => __awaiter(this, [virtualMachineId_1, ...args_1], void 0, function* (virtualMachineId, options = {}) {
            // verify required parameter 'virtualMachineId' is not null or undefined
            (0, common_1.assertParamExists)('hibernateVirtualMachine', 'virtualMachineId', virtualMachineId);
        ...
        resizeVirtualMachine: (virtualMachineId_1, payload_1, ...args_1) => __awaiter(this, [virtualMachineId_1, payload_1, ...args_1], void 0, function* (virtualMachineId, payload, options = {}) {
            // verify required parameter 'virtualMachineId' is not null or undefined
            (0, common_1.assertParamExists)('resizeVirtualMachine', 'virtualMachineId', virtualMachineId);
            // verify required parameter 'payload' is not null or undefined
            (0, common_1.assertParamExists)('resizeVirtualMachine', 'payload', payload);
        ...
        restoreVirtualMachineFromHibernation: (virtualMachineId_1, ...args_1) => __awaiter(this, [virtualMachineId_1, ...args_1], void 0, function* (virtualMachineId, options = {}) {
            // verify required parameter 'virtualMachineId' is not null or undefined
            (0, common_1.assertParamExists)('restoreVirtualMachineFromHibernation', 'virtualMachineId', virtualMachineId);
        ...
        retrieveVirtualMachineDetails: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('retrieveVirtualMachineDetails', 'id', id);
            const localVarPath = `/core/virtual-machines/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
        ...
        retrieveVirtualMachinePerformanceMetrics: (virtualMachineId_1, duration_1, ...args_1) => __awaiter(this, [virtualMachineId_1, duration_1, ...args_1], void 0, function* (virtualMachineId, duration, options = {}) {
            // verify required parameter 'virtualMachineId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveVirtualMachinePerformanceMetrics', 'virtualMachineId', virtualMachineId);
        ...
        retrieveVirtualMachinesAssociatedWithAContract: (contractId_1, page_1, pageSize_1, search_1, ...args_1) => __awaiter(this, [contractId_1, page_1, pageSize_1, search_1, ...args_1], void 0, function* (contractId, page, pageSize, search, options = {}) {
            // verify required parameter 'contractId' is not null or undefined
            (0, common_1.assertParamExists)('retrieveVirtualMachinesAssociatedWithAContract', 'contractId', contractId);
        ...
        startVirtualMachine: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('startVirtualMachine', 'id', id);
        ...
        stopVirtualMachine: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('stopVirtualMachine', 'id', id);
    ...
    return {
        ...
        addFirewallRuleToVirtualMachine(id, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.addFirewallRuleToVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        attachFirewallsToAVirtualMachine(vmId, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.attachFirewallsToAVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        createSnapshotFromAVirtualMachine(vmId, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.createSnapshotFromAVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        createVirtualMachines(payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.createVirtualMachines']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        deleteFirewallRuleFromVirtualMachine(virtualMachineId, sgRuleId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.deleteFirewallRuleFromVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        deleteVirtualMachine(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.deleteVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        editVirtualMachineLabels(virtualMachineId, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.editVirtualMachineLabels']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        hardRebootVirtualMachine(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.hardRebootVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        hibernateVirtualMachine(virtualMachineId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.hibernateVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        listVirtualMachines(page, pageSize, search, environment, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.listVirtualMachines']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        resizeVirtualMachine(virtualMachineId, payload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.resizeVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        restoreVirtualMachineFromHibernation(virtualMachineId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.restoreVirtualMachineFromHibernation']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveVirtualMachineDetails(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.retrieveVirtualMachineDetails']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveVirtualMachinePerformanceMetrics(virtualMachineId, duration, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.retrieveVirtualMachinePerformanceMetrics']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        retrieveVirtualMachinesAssociatedWithAContract(contractId, page, pageSize, search, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.retrieveVirtualMachinesAssociatedWithAContract']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        startVirtualMachine(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.startVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        stopVirtualMachine(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VirtualMachineApi.stopVirtualMachine']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class VirtualMachineApi extends base_1.BaseAPI {
     ...
     */
    addFirewallRuleToVirtualMachine(id, payload, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).addFirewallRuleToVirtualMachine(id, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Attach firewalls to a virtual machine by providing the virtual machine ID in the path and the IDs of the firewalls in the request body; any firewalls not included will be detached.
     * @summary Attach firewalls to a virtual machine
     ...
     */
    attachFirewallsToAVirtualMachine(vmId, payload, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).attachFirewallsToAVirtualMachine(vmId, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Create snapshots of a virtual machine by providing the virtual machine ID in the path
     * @summary Create snapshot from a virtual machine
     ...
     */
    createSnapshotFromAVirtualMachine(vmId, payload, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).createSnapshotFromAVirtualMachine(vmId, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Creates one or more virtual machines with the specified custom configuration and features provided in the request body. For more information about the virtual machine features offered by Infrahub, [**click here**](https://infrahub-doc.nexgencloud.com/docs/virtual-machines/virtual-machine-features#create-a-virtual-machine-with-custom-features).
     * @summary Create virtual machines
     ...
     */
    createVirtualMachines(payload, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).createVirtualMachines(payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Deletes a firewall rule associated with a virtual machine. Provide the virtual machine ID and the firewall rule ID in the path to remove the specified rule from the specified virtual machine.
     * @summary Delete firewall rule from virtual machine
     ...
     */
    deleteFirewallRuleFromVirtualMachine(virtualMachineId, sgRuleId, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).deleteFirewallRuleFromVirtualMachine(virtualMachineId, sgRuleId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Permanently deletes a virtual machine. Provide the virtual machine ID in the path to delete the specified virtual machine.
     * @summary Delete virtual machine
     ...
     */
    deleteVirtualMachine(id, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).deleteVirtualMachine(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Adds one or more labels to an existing virtual machine. Provide the virtual machine ID in the path to add labels to the specified VM. For multiple labels, add a space between each label in the request body.
     * @summary Edit virtual machine labels
     ...
     */
    editVirtualMachineLabels(virtualMachineId, payload, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).editVirtualMachineLabels(virtualMachineId, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Check if a Virtual Machine name is available
     * @summary Fetch virtual machine name availability
     ...
     */
    hardRebootVirtualMachine(id, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).hardRebootVirtualMachine(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Initiates the hibernation of a virtual machine, saving its current state to disk before powering off. Provide the virtual machine ID in the path to specify the virtual machine to be hibernated.
     * @summary Hibernate virtual machine
     ...
     */
    hibernateVirtualMachine(virtualMachineId, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).hibernateVirtualMachine(virtualMachineId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of your existing virtual machines, providing configuration details for each. The list is sorted by creation date, with the oldest virtual machines displayed first.
     * @summary List virtual machines
     ...
     */
    listVirtualMachines(page, pageSize, search, environment, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).listVirtualMachines(page, pageSize, search, environment, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the hardware configuration for an existing virtual machine. Include the virtual machine ID in the path and provide the new configuration, referred to as a `flavor`, in the body of the request. For additional information resizing, [**click here**](https://infrahub-doc.nexgencloud.com/docs/hardware/flavors#modify-the-flavor-of-an-existing-virtual-machine).
     * @summary Resize virtual machine
     ...
     */
    resizeVirtualMachine(virtualMachineId, payload, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).resizeVirtualMachine(virtualMachineId, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Resumes a virtual machine from hibernation, bringing it back to an active state. Provide the virtual machine ID in the path to specify the virtual machine to be restored from hibernation.
     * @summary Restore virtual machine from hibernation
     ...
     */
    restoreVirtualMachineFromHibernation(virtualMachineId, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).restoreVirtualMachineFromHibernation(virtualMachineId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves the details of an existing virtual machine. Provide the virtual machine ID in the path, and Infrahub will return information about the corresponding VM.
     * @summary Retrieve virtual machine details
     ...
     */
    retrieveVirtualMachineDetails(id, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).retrieveVirtualMachineDetails(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves performance metrics data for a virtual machine. Provide the virtual machine ID in the path to retrieve the following data for the specified virtual machine: CPU usage, memory usage (RAM), `network.in`, `network.out`, `disk.read`, and `disk.write`. The optional `duration` parameter can be used to specify the period for retrieving performance metrics; the default value will retrieve all available data. To learn more about virtual machine performance metrics, [**click here**](https://infrahub-doc.nexgencloud.com/docs/virtual-machines/vm-performance-metrics-and-events-history#performance-metrics).
     * @summary Retrieve virtual machine performance metrics
     ...
     */
    retrieveVirtualMachinePerformanceMetrics(virtualMachineId, duration, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).retrieveVirtualMachinePerformanceMetrics(virtualMachineId, duration, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a list of virtual machines associated with a contract, providing details such as virtual machine name, timestamp, flavor name, and other relevant information. Please provide the ID of the relevant contract in the path.
     * @summary Retrieve virtual machines associated with a contract
     ...
     */
    retrieveVirtualMachinesAssociatedWithAContract(contractId, page, pageSize, search, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).retrieveVirtualMachinesAssociatedWithAContract(contractId, page, pageSize, search, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Initiates the startup of a virtual machine. Provide the virtual machine ID in the path to initiate the starting of the specified virtual machine.
     * @summary Start virtual machine
     ...
     */
    startVirtualMachine(id, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).startVirtualMachine(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Shuts down a virtual machine. Provide the virtual machine ID in the path to initiate the shutdown process for the specified virtual machine.
     * @summary Stop virtual machine
     ...
     */
    stopVirtualMachine(id, options) {
        return (0, exports.VirtualMachineApiFp)(this.configuration).stopVirtualMachine(id, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
exports.RetrieveVirtualMachinePerformanceMetricsDurationEnum = {
    _1h: '1h',
    _2h: '2h',
    _4h: '4h',
    _6h: '6h',
...
const VirtualMachineEventsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        listVirtualMachineEvents: (virtualMachineId_1, ...args_1) => __awaiter(this, [virtualMachineId_1, ...args_1], void 0, function* (virtualMachineId, options = {}) {
            // verify required parameter 'virtualMachineId' is not null or undefined
            (0, common_1.assertParamExists)('listVirtualMachineEvents', 'virtualMachineId', virtualMachineId);
...
class VirtualMachineEventsApi extends base_1.BaseAPI {
     ...
     */
    listVirtualMachineEvents(virtualMachineId, options) {
        return (0, exports.VirtualMachineEventsApiFp)(this.configuration).listVirtualMachineEvents(virtualMachineId, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const VncUrlApiAxiosParamCreator = function (configuration) {
    return {
        ...
        getVncConsoleLink: (virtualMachineId_1, jobId_1, ...args_1) => __awaiter(this, [virtualMachineId_1, jobId_1, ...args_1], void 0, function* (virtualMachineId, jobId, options = {}) {
            // verify required parameter 'virtualMachineId' is not null or undefined
            (0, common_1.assertParamExists)('getVncConsoleLink', 'virtualMachineId', virtualMachineId);
            // verify required parameter 'jobId' is not null or undefined
            (0, common_1.assertParamExists)('getVncConsoleLink', 'jobId', jobId);
        ...
        requestInstanceConsole: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('requestInstanceConsole', 'id', id);
    ...
    return {
        ...
        getVncConsoleLink(virtualMachineId, jobId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VncUrlApi.getVncConsoleLink']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        requestInstanceConsole(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['VncUrlApi.requestInstanceConsole']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class VncUrlApi extends base_1.BaseAPI {
     ...
     */
    getVncConsoleLink(virtualMachineId, jobId, options) {
        return (0, exports.VncUrlApiFp)(this.configuration).getVncConsoleLink(virtualMachineId, jobId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Request Instance Console
     ...
     */
    requestInstanceConsole(id, options) {
        return (0, exports.VncUrlApiFp)(this.configuration).requestInstanceConsole(id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const VolumeApiAxiosParamCreator = function (configuration) {
    return {
        ...
        deleteVolume: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('deleteVolume', 'id', id);
...
class VolumeApi extends base_1.BaseAPI {
     ...
     */
    deleteVolume(id, options) {
        return (0, exports.VolumeApiFp)(this.configuration).deleteVolume(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch volume details for specific volume. This endpoint returns id, name, volume size, volume type, status, description, image_id, os_image, created_at, updated_at etc.
     * @summary Fetch Volume Details
...
const VolumeAttachmentApiAxiosParamCreator = function (configuration) {
    return {
        ...
        attachVolumesToVirtualMachine: (virtualMachineId_1, payload_1, ...args_1) => __awaiter(this, [virtualMachineId_1, payload_1, ...args_1], void 0, function* (virtualMachineId, payload, options = {}) {
            // verify required parameter 'virtualMachineId' is not null or undefined
            (0, common_1.assertParamExists)('attachVolumesToVirtualMachine', 'virtualMachineId', virtualMachineId);
            // verify required parameter 'payload' is not null or undefined
        ...
        detachVolumesFromVirtualMachine: (virtualMachineId_1, payload_1, ...args_1) => __awaiter(this, [virtualMachineId_1, payload_1, ...args_1], void 0, function* (virtualMachineId, payload, options = {}) {
            // verify required parameter 'virtualMachineId' is not null or undefined
            (0, common_1.assertParamExists)('detachVolumesFromVirtualMachine', 'virtualMachineId', virtualMachineId);
            // verify required parameter 'payload' is not null or undefined
...
class VolumeAttachmentApi extends base_1.BaseAPI {
     ...
     */
    attachVolumesToVirtualMachine(virtualMachineId, payload, options) {
        return (0, exports.VolumeAttachmentApiFp)(this.configuration).attachVolumesToVirtualMachine(virtualMachineId, payload, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Detaches one or more volumes currently attached to an existing virtual machine. Include the virtual machine ID in the path and the volume IDs in the request body to detach the specified volumes from the designated virtual machine.
     * @summary Detach volumes from virtual machine
     ...
     */
    detachVolumesFromVirtualMachine(virtualMachineId, payload, options) {
        return (0, exports.VolumeAttachmentApiFp)(this.configuration).detachVolumesFromVirtualMachine(virtualMachineId, payload, options).then((request) => request(this.axios, this.basePath));
    }
}
